...
const ListingCards: React.FC<ListingCardsProps> = ({ hook }) => {
  return (
    <div className="relative w-[90%] md:w-[48%] h-20 md:h-32 flex justify-center items-center overflow-hidden text-3xl border rounded-xl  hover:cursor-pointer group">
